...
window.addEventListener("load", (e) => {
    // console.log("here");
    var str = "";
    let projectFiles = JSON.parse(sessionStorage.getItem("projectFiles"));
    ...
    if (fileDefault) {
        ...
        for (const key in projectFiles) {
            var item = JSON.parse(projectFiles[key]);
...
function loadPage() {
    var str = "";
    var projectFiles = JSON.parse(sessionStorage.getItem("projectFiles"));
